/*
  ...
  2. Security
    ...
    - Add policies for admin access to daily stats
    - Add policy for public page view tracking
    - Add policy for admin access to page views

  3. Functions
    - `update_daily_stats()` - Calculate and update daily statistics
    - `track_page_view()` - Track individual page views
...
DROP POLICY IF EXISTS "Only admins can view daily stats" ON analytics_daily_stats;
DROP POLICY IF EXISTS "Only admins can manage daily stats" ON analytics_daily_stats;
DROP POLICY IF EXISTS "Only admins can view page views" ON analytics_page_views;
