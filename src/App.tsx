...
const ReturnsLazy = lazy(() =>
  import('./pages/Returns').then((module) => ({ default: module.Returns })),
)
...
const MyStoreLazy = lazy(() =>
  import('./pages/MyStore').then((module) => ({ default: module.MyStore })),
)
const StoreDetailsLazy = lazy(() =>
  import('./pages/StoreDetails').then((module) => ({ default: module.StoreDetails })),
)
      ...
      >
        <div className="min-h-screen bg-gray-50">
          ...
          <Routes>
            ...
            <Route
              path="/register"
              element={user ? <Navigate to="/dashboard" /> : <RegisterLazy />}
            />
