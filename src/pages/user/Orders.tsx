          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between space-y-4 md:space-y-0">
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-4">
              ...
              <div className="relative">
                ...
                <select
                  ...
                  className="pl-10 pr-8 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-orange focus:border-transparent appearance-none bg-white"
                >
            ...
            <div className="flex items-center space-x-2">
              ...
              <select
                ...
                className="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-primary-orange focus:border-transparent text-sm"
              >
                ...
                <div className="p-6">
                  ...
                  <div className="mt-6 flex justify-end">
                    <button
                      ...
                      className="inline-flex items-center space-x-2 bg-primary-orange text-white px-6 py-3 rounded-lg hover:bg-primary-orange/90 transition-colors font-medium"
                    >
