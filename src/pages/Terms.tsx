          ...
          <div className="prose max-w-none">
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Welcome to Ulisha Store. These terms and conditions outline the rules and
                regulations for the use of our website and services.
              </p>
              <p className="text-gray-600">
                By accessing this website, we assume you accept these terms and conditions in full.
                Do not continue to use Ulisha Stores website if you do not accept all of the terms
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Unless otherwise stated, Ulisha Store and/or its licensors own the intellectual
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                You must be at least 18 years of age to use this website. You must provide true,
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Prices for products are subject to change without notice. We reserve the right at
                any time to modify or discontinue any product without notice at any time.
              </p>
              <p className="text-gray-600">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                ...
                cryptocurrencies. All payments must be received in full before products are shipped.
              </p>
              <p className="text-gray-600">
                Shipping times may vary depending on the delivery location and product availability.
                We are not responsible for delays caused by customs or other factors beyond our
                control.
              </p>
            </section>
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600 mb-4">
                Our affiliate program allows users to earn commissions by referring new customers.
                Commissions are paid according to our affiliate terms and conditions.
              </p>
              <p className="text-gray-600">
            ...
            <section className="mb-8">
              ...
              <p className="text-gray-600">
                In no event shall Ulisha Store be liable for any direct, indirect, incidental,
