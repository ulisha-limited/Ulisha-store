...
export function Affiliate() {
  ...
  const fetchAffiliateData = async () => {
    try {
      ...
      const { data: settings } = await supabase.from('affiliate_settings').select('*').maybeSingle()
        ...
        <div className="bg-white rounded-lg shadow-md overflow-hidden">
          <div className="p-6">
            <div className="flex items-center justify-between mb-6">
              ...
              <div className="text-sm text-gray-500">Commission Rate: {commissionRate}%</div>
            </div>
            ...
            {!affiliateAccount ? (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600 mb-2">
                  Earn {commissionRate}% commission on every successful referral purchase
                </p>
              ...
              <div className="space-y-6">
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <p className="mt-2 text-sm text-gray-500">
                    Share this link with your friends and earn {commissionRate}% when they make a
                    purchase
                  </p>
                </div>
